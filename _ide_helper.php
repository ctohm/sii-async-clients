...
namespace Illuminate\Support\Facades {
        ...
        class Auth
        {
             ...
             * @static
             */
            public static function resolved($callback): void
        ...
        class Schema
        {
             ...
             * @static
             */
            public static function refreshDatabaseFile(): void
            {
                /** @var \Illuminate\Database\Schema\SQLiteBuilder $instance */
             ...
             * @static
             */
            public static function getAllTables(): void
            {            //Method inherited from \Illuminate\Database\Schema\Builder
                /** @var \Illuminate\Database\Schema\SQLiteBuilder $instance */
...
namespace Illuminate\Support {
        class Str
        {
            ...
            {
                return self::detectEncoding($value);
            }
            ...
            {
                return self::betweenInclusive($value, $from, $to);
            }
            ...
            {
                return self::betweenTags($value, $tag);
            }
            ...
            {
                return self::insideTags($value, $tag);
            }
        }
        ...
        class Stringable
        {
            ...
            {
                return self::betweenInclusive($from, $to);
            }
...
namespace Illuminate\Console {
        class Command
        {
            ...
            {
                return self::notify($text, $body, $icon);
            }
            ...
            {
                return self::task($title, $task, $loadingText);
            }
        }
}
