...
namespace CTOhm\SiiAsyncClients\Wsdl\AsyncSoap\Soap;
 ...
 class SoapInterpreter extends Interpreter
 {
     /**
      * @var InternalSoapClient
      */
     private $soap;
     ...
     public function __construct(
         ...
         $this->soap = new InternalSoapClient($wsdl, $options);
     }
     ...
     public function getSoapClient(): InternalSoapClient
     {
         return $this->soap;
     }
 }
